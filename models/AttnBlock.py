...
def getAttentionBlock(attnType, dim, reduction=16, num_heads=8, bias=False, LayerNorm_type='WithBias'):
    if attnType == "SELayer":
        return SELayer(channel=dim, reduction=reduction)
    elif attnType == "qkv":
        return MDTA(dim, num_heads, bias)
    elif attnType == 'qkv_norm':
        return MDTABlock(dim, num_heads, bias, LayerNorm_type)
